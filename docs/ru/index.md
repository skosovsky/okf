...
В этом репозитории три публичные поверхности:
...
3. **Agent skill** - `skills/open-knowledge-format` для создания, конвертации, обогащения и проверки OKF bundles.
...
Смотри отдельные разделы: [Toolkit](toolkit/) и [Skill](skill/).
